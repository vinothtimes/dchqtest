...
require ('../include/candidates.inc.php');
if (!isset($_REQUEST['mode'])) {
	$_REQUEST['mode'] = 'VIEW';
}
$mode = $_REQUEST['mode'];
$CandidateForm = &JB_get_DynamicFormObject(5);
$CandidateForm->set_mode($mode);


JB_admin_header('Admin -> Candidate Signup Form');


?>
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000; "></div>
<b>[Candidate's Signup Form]</b><span style="background-color: <?php if (($_REQUEST['mode']!='EDIT')) { echo "#FFFFCC"; }  ?>; border-style:outset; padding: 5px;"><a href="signup_candidate_form.php?mode=VIEW">View Form</a></span> <span style="background-color:  <?php if (($_REQUEST['mode']=='EDIT') && ($_REQUEST['NEW_FIELD']=='')) { echo "#FFFFCC"; }  ?>; border-style:outset; padding: 5px;"><a href="signup_candidate_form.php?mode=EDIT">Edit Fields</a></span> <span style="background-color: <?php if (($_REQUEST['mode']=='EDIT') && ($_REQUEST['NEW_FIELD']!='')) { echo "#FFFFCC"; }  ?>; border-style:outset; padding: 5px;"><a href="signup_candidate_form.php?NEW_FIELD=YES&mode=EDIT">New Field</a></span> &nbsp; &nbsp; <span style="background-color: <?php  echo "#F2F2F2";?> ; border-style:outset; padding: 5px;"><a href="candidatelist.php">Candidate List</a></span>
...
<tr>
	...
	<?php if ((($_REQUEST['mode']=='EDIT') && ($_REQUEST['field_id']!='')) || ($NEW_FIELD=='YES')) JB_field_form($NEW_FIELD, $data, 5); ?>
