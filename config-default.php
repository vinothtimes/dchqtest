...
define('JB_SITE_NAME',  'Jamit Job Board 3.6.13');
...
//if (true) {
	...
	define('JB_FILE_HTTP_PATH',  str_replace('http:', 'https:', ''));
	define('JB_BASE_HTTP_PATH',  str_replace('http:', 'https:', ''));
	define('JB_IMG_HTTP_PATH',  str_replace('http:', 'https:', ''));
	
} else {
	
	define('JB_SITE_LOGO_URL', 'http://www.jamit.com.au/images/logo.gif');
	define('JB_FILE_HTTP_PATH', '');
	define('JB_BASE_HTTP_PATH',  '');
	define('JB_IMG_HTTP_PATH', '');
}
...
define('JB_CAT_MOD_REWRITE', 'NO');
define('JB_JOB_MOD_REWRITE', 'NO');
define('JB_PRO_MOD_REWRITE', 'NO');
define('JB_MOD_REWRITE_DIR', 'category/');
define('JB_MOD_REWRITE_JOB_DIR', 'job/%CLASS%/%DATE%/');
define('JB_MOD_REWRITE_PRO_DIR', 'profile/');
define('JB_JOB_PAGES_MOD_REWRITE', 'NO');
...
define('JB_ONLINE_APP_EMAIL_ADMIN', '');
define('JB_ONLINE_APP_EMAIL_PREMIUM', 'YES');
define('JB_ONLINE_APP_EMAIL_STD', 'YES');
define('JB_ONLINE_APP_REVEAL_PREMIUM', 'YES');
define('JB_ONLINE_APP_REVEAL_STD', 'YES');
define('JB_ONLINE_APP_REVEAL_RESUME', 'YES');
define('JB_TAF_SIGN_IN', '');
define('JB_ANON_RESUME_ENABLED', '');
define('JB_FIELD_BLOCK_SWITCH', 'NO');
...
define('JB_MYSQL_USER', '');
define('JB_MYSQL_PASS', '');
define('JB_MYSQL_DB', '');
//date & time
...
define('JB_POSTS_HIDDEN_FIELDS_SWITCH', '');
